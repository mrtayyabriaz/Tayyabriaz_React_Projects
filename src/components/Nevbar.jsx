...
import { AlignCenter, Calculator, CloudLightning, Github, GithubIcon, HomeIcon, PcCase, X } from 'lucide-react';
              ...
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                ...
                <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                  ...
                  {open ? (
                    ...
                    <AlignCenter className="block h-6 w-6" aria-hidden="true" />
                  )}
                </Disclosure.Button>
              </div>
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href="https://mrtayyabriaz.netlify.app/"
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href="https://my-todo-place.netlify.app/"
                            className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700')}
                          >
                            🔗 ToDo Place
                          </a>
